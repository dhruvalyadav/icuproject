...
@NamedQueries({
    ...
    @NamedQuery(name = "Patientdaysheet.findByPatient", query = "SELECT p FROM Patientdaysheet p WHERE p.patientadmission.patient.patientid = :patientid ORDER BY p.patientdaysheetid ASC"),
