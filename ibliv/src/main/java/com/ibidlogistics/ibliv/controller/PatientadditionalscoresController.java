...
public class PatientadditionalscoresController {
    ...
    @GetMapping("/patientadditonalscores/{id}")
    public List<Patientadditionalscores> getPatientId(@PathVariable("id") Integer id){
        return Patientadditionalscorerepository.findByPatientId(id);
   }
